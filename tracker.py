# -*- coding: utf-8 -*-
"""
Created on Wed Sep 20 06:14:20 2017
...
class tracker():
    ...
    # Specify all unassigned variables for every new instance
    def __init__(self, Mywindow_width, Mywindow_height, Mymargin, My_ym = 1, My_xm = 1, Mysmooth_factor = 15):
        ...
        # the window pixel width of the center values, used to count pixels inside center windows to determine curved values
        self.window_width = Mywindow_width
        
        # the window pixel height of the center values, used to count pixels inside center windows to determine curved values
    ...
    def find_window_centroids(self, warped):
        ...
        # return averaged values of the line centers, helps to keep the markers from jumpingn around too much
