# -*- coding: utf-8 -*-
"""
Created on Mon Sep 18 04:30:03 2017
...
def color_thresh1(img, sthresh=(0, 255), vthresh=(0,255)):
    ...
    #output[(s_binary==1)&(v_binary==1)&(gray_binary==1)]=1
...
for idx, fname in enumerate(images):
    ...
    # Save intermediate images for documentation
    undistort = img
    ...
    '''' 
    # This is the approach shown in the Q&A videos
    bot_width = 0.76
    mid_width = 0.08
    height_pct = 0.625
    bottom_trim = 0.935
...
#    src = np.float32([[230, 700], [1200, 700], [680, 450], [600, 450]])
 #   dst = np.float32([[310, 710], [960, 710], [960, 10], [310, 10]])
    ...
    window_width =  25  #60
    window_height = 60  #80 based on Udacity class 
    
    
    ## Set up the overall class to do all the tracking
    curve_centers = tracker(Mywindow_width = window_width, Mywindow_height = window_height, Mymargin = 100, My_ym = 10/720, My_xm = 4/384, Mysmooth_factor = 15)
